...
Скрипт спросит, как панель будет доступна — бесплатный поддомен, свой домен или просто
по адресу — и всё остальное сделает сам: пользователь, служба, фаервол, сертификат.
